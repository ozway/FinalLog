...
cubmethods <- "cubfits"
fn.in <- "../prestonYeast/S.cerevisiae.S288c.fasta"
fn.phi.in <- "../prestonYeast/pyeast.phi.tsv"
#fn.in <- "../prestonYeast/section1of5.fasta"
#fn.phi.in <- "../prestonYeast/section1of5.csv"
fname <- paste("pYeast.nse.", suffix, sep = "");
out.folder <- paste("../results/np/", substr(Sys.Date(), 6, 10), "/",sep="")
